...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Area.boundary'
        db.add_column('dealer_area', 'boundary',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Area.boundary'
        db.delete_column('dealer_area', 'boundary')


    models = {
        'dealer.area': {
            'Meta': {'object_name': 'Area'},
            'boundary': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
