...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('document_article', 'site_id')


    def backwards(self, orm):
        # Adding field 'Article.site'
        db.add_column('document_article', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='articles', to=orm['sites.Site']),
                      keep_default=False)
