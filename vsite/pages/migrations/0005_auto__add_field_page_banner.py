...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.banner'
        db.add_column('pages_page', 'banner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.banner'
        db.delete_column('pages_page', 'banner')
    ...
    models = {
        'pages.page': {
            ...
            'banner': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'cached_url': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300', 'db_index': 'True', 'blank': 'True'}),
            'col': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
