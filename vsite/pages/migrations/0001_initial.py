...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pages_page', (
            ...
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages', to=orm['sites.Site'])),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pages', null=True, to=orm['document.Article'])),
    ...
    models = {
        ...
        'pages.page': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pages'", 'null': 'True', 'to': "orm['document.Article']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
