...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Press._is_active'
        db.delete_column('press_press', '_is_active')

        # Adding field 'Press.press_from'
        db.add_column('press_press', 'press_from',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Press.is_active'
        db.add_column('press_press', 'is_active',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Press._is_active'
        db.add_column('press_press', '_is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Press.press_from'
        db.delete_column('press_press', 'press_from')

        # Deleting field 'Press.is_active'
        db.delete_column('press_press', 'is_active')
    ...
    models = {
        'press.press': {
            ...
            'press_from': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
