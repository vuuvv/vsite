...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MagzineImage.active'
        db.delete_column('press_magzineimage', 'active')

        # Adding field 'Magzine.active'
        db.add_column('press_magzine', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MagzineImage.active'
        db.add_column('press_magzineimage', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Magzine.active'
        db.delete_column('press_magzine', 'active')
    ...
    models = {
        ...
        'users.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 22, 21, 43, 35, 973000)'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_superuser': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 22, 21, 43, 35, 973000)'}),
