...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Press.tags'
        db.add_column('press_press', 'tags',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Press.thumbnail'
        db.add_column('press_press', 'thumbnail',
                      self.gf('vsite.core.fields.ImageField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Press.tags'
        db.delete_column('press_press', 'tags')

        # Deleting field 'Press.thumbnail'
        db.delete_column('press_press', 'thumbnail')
