...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.cached_url'
        db.add_column('product_category', 'cached_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.cached_url'
        db.delete_column('product_category', 'cached_url')
