...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Style.category'
        db.add_column('product_style', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='styles', to=orm['product.StyleCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Style.category'
        db.delete_column('product_style', 'category_id')
