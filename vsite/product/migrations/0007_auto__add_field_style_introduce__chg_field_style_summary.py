...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Style.introduce'
        db.add_column('product_style', 'introduce',
                      self.gf('vsite.core.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Style.summary'
        db.alter_column('product_style', 'summary', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Style.introduce'
        db.delete_column('product_style', 'introduce')


        # Changing field 'Style.summary'
        db.alter_column('product_style', 'summary', self.gf('vsite.core.fields.RichTextField')())
