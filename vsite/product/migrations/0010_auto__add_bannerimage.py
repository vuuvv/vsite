...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('product_bannerimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='banner_images', to=orm['product.Category'])),
        ))
        db.send_create_signal('product', ['BannerImage'])


    def backwards(self, orm):
        # Deleting model 'BannerImage'
        db.delete_table('product_bannerimage')
