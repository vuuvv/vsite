...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.feature_image'
        db.add_column('product_category', 'feature_image',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.feature_image'
        db.delete_column('product_category', 'feature_image')


    models = {
        'product.bannerimage': {
            'Meta': {'object_name': 'BannerImage'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'banner_images'", 'to': "orm['product.Category']"}),
        ...
        'product.category': {
            ...
            'cached_url': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
        ...
        'product.product': {
            ...
            'technologies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'products'", 'blank': 'True', 'to': "orm['product.Technology']"}),
        ...
        'product.style': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'styles'", 'to': "orm['product.StyleCategory']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'introduce': ('vsite.core.fields.RichTextField', [], {'blank': 'True'}),
            'keywords': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '999'}),
