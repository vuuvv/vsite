define(function(require) {
	...
	var config = require('manage/config'),
		FileDialogTemplate = require('manage/templates/filemanage/filedialog.html'),
		FileListTemplate = require('manage/templates/filemanage/filelist.html'),
		FileTemplate = require('manage/templates/filemanage/file.html'),
		FolderTemplate = require('manage/templates/filemanage/folder.html');
